...
namespace StoryCanvas.WPF.Converters.MainPage
{
	...
	/// </summary>
	class MainEditModeListIndexConverter : ValueConverterBase<MainMode, int>
	{
		private static readonly MainListItem[] MainList =
		{
			new MainListItem { Mode = MainMode.StorySettingPage, Index = 0 },
			new MainListItem { Mode = MainMode.ChapterTextPage, Index = 1 },
			new MainListItem { Mode = MainMode.SceneDesignerPage, Index = 2 },
		};
