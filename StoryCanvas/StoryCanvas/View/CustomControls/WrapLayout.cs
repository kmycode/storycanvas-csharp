...
namespace StoryCanvas.View.CustomControls
{
	...
	{
		Dictionary<Xamarin.Forms.View, SizeRequest> layoutCache = new Dictionary<Xamarin.Forms.View, SizeRequest>();
		...
		private List<List<Tuple<Xamarin.Forms.View, Rectangle>>> NaiveLayout(double width, double height, out double lastX, out double lastY)
		{
			double startX = 0;
			double startY = 0;
			double right = width;
			...
			var result = new List<List<Tuple<Xamarin.Forms.View, Rectangle>>>();
			var currentList = new List<Tuple<Xamarin.Forms.View, Rectangle>>();
			...
			foreach (var child in Children)
			{
				...
				if (startX + paddedWidth > right)
				{
					...
					if (currentList.Count > 0)
					{
						...
						currentList = new List<Tuple<Xamarin.Forms.View, Rectangle>>();
					}
				}

				currentList.Add(new Tuple<Xamarin.Forms.View, Rectangle>(child, new Rectangle(startX, startY, sizeRequest.Request.Width, sizeRequest.Request.Height)));
	...
	/// </summary>
	public class WrapLayoutOld : Layout<Xamarin.Forms.View>
	{
		/// <summary>
