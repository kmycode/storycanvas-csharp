...
{
	/// <summary>
	/// ItemsView 風 Xamarin.Forms.View
	/// </summary>
	public class ItemsView : ContentView
	{
		...
		{
			var control = bindable as ItemsView;
			if (control == null)
			{
				return;
			}
		...
		/// </summary>
		public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create<ItemsView, IEnumerable>(
			p => p.ItemsSource,
		...
		/// </summary>
		public static readonly BindableProperty ItemTemplateProperty = BindableProperty.Create<ItemsView, DataTemplate>(
			p => p.ItemTemplate,
