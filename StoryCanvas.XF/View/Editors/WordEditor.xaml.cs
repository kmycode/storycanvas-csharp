...
{
	public partial class WordEditor : ContentView
	{
		public WordEditor()
		{
			InitializeComponent();
			this.BindingContext = new WordEntityViewModel();
		...
		public static readonly BindableProperty IsPrimaryProperty = BindableProperty.Create(
				"IsPrimary",                            // プロパティ名
				typeof(bool),                           // プロパティの型
				typeof(WordEditor),                   // プロパティを持つ View の型
				false,                                  // 初期値
		...
		{
			var viewModel = this.BindingContext as WordEntityViewModel;
			if (viewModel != null)
			{
